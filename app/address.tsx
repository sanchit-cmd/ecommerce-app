...
export default function AddressScreen() {
    ...
    const [phoneVerificationStep, setPhoneVerificationStep] = useState<'phone' | 'otp' | 'form'>(editingAddress ? 'form' : 'phone');
            ...
            return (
                <View style={styles.verificationContainer}>
                    <View style={styles.verificationCard}>
                        ...
                        />
                        <TouchableOpacity
                            style={[styles.button, styles.saveButton, verificationLoading && styles.disabledButton]}
